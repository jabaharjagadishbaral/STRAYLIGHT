...
- Procedural synthwave BGM with in-game music toggle (no external audio asset required)
- Redesigned glass/neon HUD, console garage interface, scanlines and vignette polish
- Corrected mobile left/right steering button mapping
